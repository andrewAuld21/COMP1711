...
int main() {
    ...
    // Even if in this area we do not specify that the array size is [3], we can leave [] blank because we already
    // clarify that by putting 3 items in between the {} in each section
